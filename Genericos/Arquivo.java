...
public class Arquivo<T extends Registro> {
    ...
    public Arquivo(String na, Constructor<T> c) throws Exception {
        ...
        if (!d.exists()) {
            System.out.println("Criando diretório de dados...");
            d.mkdir();
        }
        d = new File("." + File.separator + "dados" + File.separator + na);
        if (!d.exists()) {
            d.mkdir();
            System.out.println("Criando diretório para " + na + "...");
        }
        this.nomeArquivo = "." + File.separator + "dados" + File.separator + na + File.separator + na + ".db";
        this.construtor = c;
        ...
        indiceDireto = new HashExtensivel<>(
                ...
                4,
                "." + File.separator + "dados" + File.separator + na + File.separator + na + ".d.db", // diretório
                "." + File.separator + "dados" + File.separator + na + File.separator + na + ".c.db" // cestos
        );
    }
    ...
    // retira um registro à lista de excluídos para reuso, mas com o risco de algum
    // desperdício
    // se necessário, o código pode ser alterado para controlar um limite máximo de
    // desperdício
